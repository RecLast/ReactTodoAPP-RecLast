...
import { selectWeeklyTasks } from '@/store/features/tasks/taskSelectors'

const WeeklyTasks: React.FC = () => {
  const { t } = useTranslation()
  const tasks = useSelector(selectWeeklyTasks)
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold">{t('weeklyTasks')}</h1>
      
      <TaskForm timeframe="weekly" />
